 ...
 * </p>
 */
#define	OS_API_VERSION(ADD,REM) 1
...
#define	GS_EXPOSE(X)	1 // We want to expose everything! was: (!GS_NONFRAGILE || defined(EXPOSE_##X##_IVARS))
...
#ifndef GS_RETURNS_INNER_POINTER
#if __has_attribute(objc_returns_inner_pointer)
#define GS_RETURNS_INNER_POINTER __attribute__((objc_returns_inner_pointer))
#else
#define GS_RETURNS_INNER_POINTER
#endif
#endif

#ifndef GS_RETURNS_RETAINED
#if __has_attribute(ns_returns_retained)
#define GS_RETURNS_RETAINED __attribute__((ns_returns_retained))
#else
#define GS_RETURNS_RETAINED
#endif
#endif

#if __has_feature(attribute_ns_consumed)
#define GS_RELEASES_ARGUMENT __attribute__((ns_consumed))
#else
#define GS_RELEASES_ARGUMENT
#endif

#if __has_feature(attribute_ns_consumes_self)
#define GS_REPLACES_RECEIVER __attribute__((ns_consumes_self))  GS_RETURNS_RETAINED
#else
#define GS_RETURNS_RETAINED
#endif

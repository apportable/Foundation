...
- (BOOL)setResourceValue:(id)value forKey:(NSString *)key error:(NSError **)error NS_UNIMPLEMENTED;

- (BOOL)checkResourceIsReachableAndReturnError:(NSError **)error NS_UNIMPLEMENTED;

- (BOOL)getResourceValue:(id *)value forKey:(NSString *)key error:(NSError **)error NS_UNIMPLEMENTED;

 ...
 */
    ...
    ,
    NSUTF16BigEndianStringEncoding = 0x9000100,
    NSUTF16LittleEndianStringEncoding = 0x9400100,
    NSUTF32StringEncoding = 0x8c00100,
    NSUTF32BigEndianStringEncoding = 0x9800100,
    NSUTF32LittleEndianStringEncoding = 0x9c00100
#endif
};
...
#if OS_API_VERSION(100400,GS_API_LATEST) && GS_API_VERSION( 10200,GS_API_LATEST)
- (const char*)cStringUsingEncoding:(NSStringEncoding)encoding GS_RETURNS_INNER_POINTER;
...
- (id)initWithFormat:(NSString*)format
    locale:(id)locale, ...NS_FORMAT_FUNCTION(1,3);
- (id)initWithFormat:(NSString*)format
    locale:(id)locale
    arguments:(va_list)argList NS_FORMAT_FUNCTION(1,0);
...
- (const char *)UTF8String GS_RETURNS_INNER_POINTER;
#endif

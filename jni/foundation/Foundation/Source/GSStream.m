...
// For the CFStream implementations these really should be the same pointers but we can 
// settle for atleast the same value as constants (which should get optimized to the same pointer

...
_NSFoundationUncaughtExceptionHandler (NSException *exception)
{
    ...
    fflush(stderr); /* NEEDED UNDER MINGW */
    [pool drain];
#if defined(NS_TERMINATE_ON_EXCEPTIONS)
    _terminate();
#endif
}
...
// TODO: FIXME when exceptions are not borked.
// #if defined(_NATIVE_OBJC_EXCEPTIONS)
// @throw self;
// #else
    {
        ...
        {
// This causes crashes from an improper handler assignment somewhere upstream
#if 0
...
{
    // IGNORE IT! they are never right...
}

void
_NSSetUncaughtExceptionHandler(NSUncaughtExceptionHandler *handler)
{

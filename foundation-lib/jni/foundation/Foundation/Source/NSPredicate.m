...
- (GSBlockPredicate *)initWithBlock:(BOOL (^)(id evaluatedObject, NSDictionary *bindings))block;
...
- (BOOL)evaluateWithObject:(id)object
{
    return [self evaluateWithObject:object substitutionVariables:NULL];
}

- (BOOL)evaluateWithObject:(id)object substitutionVariables:(NSDictionary *)variables
{
    return _block(object, variables);
}
...
// add arithmetic functions: average, median, mode, stddev, sqrt, log, ln, exp,
// floor, ceiling, abs, trunc, random, randomn, now

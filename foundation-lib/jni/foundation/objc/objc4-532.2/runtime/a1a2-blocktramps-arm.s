...
.text
	...
	.globl _a1a2_tramphead
	.globl _a1a2_firsttramp
	.globl _a1a2_nexttramp
	.globl _a1a2_trampend
...
#if THUMB2
	.thumb
	.thumb_func _a1a2_tramphead
	.thumb_func _a1a2_firsttramp
	.thumb_func _a1a2_nexttramp
	.thumb_func _a1a2_trampend
#else
	// don't use Thumb-1
	.arm
#endif
...
_a1a2_tramphead:
	...
	adr  r12, _a1a2_tramphead_nt // text page
...
.align 3
.long _a1a2_firsttramp
_a1a2_firsttramp:
    TrampolineEntry

.long _a1a2_nexttramp
_a1a2_nexttramp:
TrampolineEntry
TrampolineEntry
TrampolineEntry

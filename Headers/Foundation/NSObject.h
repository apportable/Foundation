...
- (id)autorelease;
- (id)awakeAfterUsingCoder:(NSCoder*)aDecoder GS_REPLACES_RECEIVER;
- (Class)class;
...
NS_INLINE CF_RETURNS_RETAINED CFTypeRef CFBridgingRetain(id obj)
{
    return (__bridge_retained CFTypeRef)obj;
}

NS_INLINE id CFBridgingRelease(CFTypeRef CF_CONSUMED obj)
{
...
@interface NSObject (doingItWrong)
+ (BOOL)_objectIsValid:(id)object __attribute__((unavailable));
@end

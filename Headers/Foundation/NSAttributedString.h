...
- (void)enumerateAttributesInRange:(NSRange)range
    ...
    usingBlock:(void (^)(NSDictionary *attrs, NSRange range, BOOL *stop))block NS_UNIMPLEMENTED;

- (void)enumerateAttribute:(NSString *)name
    inRange:(NSRange)range
    options:(NSAttributedStringEnumerationOptions)options
    usingBlock:(void (^)(id value, NSRange range, BOOL *stop))block NS_UNIMPLEMENTED;

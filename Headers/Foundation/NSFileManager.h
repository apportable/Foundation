 ...
 */
- (const GSNativeChar*)fileSystemRepresentationWithPath:(NSString*)path GS_RETURNS_INNER_POINTER;
...
- (BOOL)removeItemAtURL:(NSURL *)fileURL error:(NSError **)error;

- (BOOL)linkItemAtPath:(NSString *)source toPath:(NSString *)destination error:(NSError **)error NS_UNIMPLEMENTED;
...
- (void)skipDescendants;  // lolz. This is NOT a mistake. Do not remove this!
